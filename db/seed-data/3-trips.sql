...
INSERT INTO trip_members VALUES
    (1, 1, 1, 1, 0, (unixepoch() * 1000)),
    (1, 2, 1, 1, 0, (unixepoch() * 1000)),
    (1, 3, 0, 1, 0, (unixepoch() * 1000));
...
INSERT INTO trip_members VALUES
    (2, 1, 1, 0, 0, (unixepoch() * 1000)),
    (2, 2, 0, 0, 0, (unixepoch() * 1000)),
    (2, 3, 0, 0, 1, (unixepoch() * 1000));
...
INSERT INTO trip_members VALUES
    (3, 1, 1, 0, 0, (unixepoch() * 1000)),
    (3, 3, 1, 0, 1, (unixepoch() * 1000)),
    (3, 4, 0, 0, 1, (unixepoch() * 1000)),
    (3, 5, 0, 0, 1, (unixepoch() * 1000));
...
INSERT INTO trip_members VALUES
    (4, 1, 1, 0, 0, (unixepoch() * 1000)),
    (4, 2, 1, 0, 0, (unixepoch() * 1000)),
    (4, 4, 0, 0, 0, (unixepoch() * 1000)),
    (4, 5, 0, 0, 1, (unixepoch() * 1000));
...
INSERT INTO trip_members VALUES
    (5, 1, 1, 0, 0, (unixepoch() * 1000)),
    (5, 2, 0, 0, 1, (unixepoch() * 1000)),
    (5, 3, 0, 0, 1, (unixepoch() * 1000)),
    (5, 4, 0, 0, 1, (unixepoch() * 1000)),
    (5, 5, 0, 0, 1, (unixepoch() * 1000));
...
INSERT INTO trip_members VALUES
    (6, 1, 1, 0, 0, (unixepoch() * 1000)),
    (6, 2, 1, 0, 0, (unixepoch() * 1000)),
    (6, 3, 0, 0, 0, (unixepoch() * 1000)),
    (6, 4, 0, 0, 0, (unixepoch() * 1000));
